...
import { settleTerminalErrorClaims } from "./pending-claim-settlement"
    ...
    try {
      ...
      switch (settlement.kind) {
        ...
        case "message-delivered":
          ...
          return
        case "stale-session": {
          const currentMember = settlement.runtimeState.members.find((member) => member.name === runtimeMember.memberName)
          log("team member session error skipped: session already replaced by fallback retry", {
            ...
            teamRunId: settlement.runtimeState.teamRunId,
            teamName: settlement.runtimeState.teamName,
            memberName: runtimeMember.memberName,
            erroredSessionID,
        ...
        case "settled": {
          const nextRuntimeState = settlement.runtimeState
          ...
          log("team member session errored", {
            ...
            requeuedCount: settlement.requeuedCount,
