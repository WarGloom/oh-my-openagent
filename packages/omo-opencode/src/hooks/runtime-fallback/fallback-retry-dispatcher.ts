...
export type SuppressUnsafeAutoReplayOptions = {
  readonly sessionID: string
  readonly state?: FallbackState | undefined
  readonly source: string
}

type DispatchFallbackRetryOptions = SuppressUnsafeAutoReplayOptions & {
  state: FallbackState
  fallbackModels: string[]
  resolvedAgent?: string
}

export function suppressUnsafeAutoReplay(
  deps: HookDeps,
  helpers: AutoRetryHelpers,
  options: SuppressUnsafeAutoReplayOptions,
): boolean {
